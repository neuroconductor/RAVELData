...
pblapply(1:4, function(j){antsImageWrite(scans[[j]], paste0("extdata/scan",j,".nii.gz"))})
pblapply(1:4, function(j){antsImageWrite(scans_n4_reg_brain[[j]], paste0("extdata/scan",j,"_processed.nii.gz"))})
pblapply(1:4, function(j){writeNIfTI(segs[[j]], paste0("extdata/scan",j,"_seg.nii.gz"))})
pblapply(1:4, function(j){writeNIfTI(segs_csf[[j]], paste0("extdata/scan",j,"_csf_mask.nii.gz"))})
